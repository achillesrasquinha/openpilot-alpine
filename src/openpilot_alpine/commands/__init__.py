...
from openpilot_alpine.commands.util 	import cli_format
...
from openpilot_alpine 	import cli
from bpyutils._compat		    import builtins, iteritems
from openpilot_alpine.__attr__      	import __name__
from openpilot_alpine.exception      import DependencyNotFoundError
...
"openpilot_alpine". Kindly post an issue at https://github.com/achillesrasquinha/openpilot_alpine/issues""", cli.RED))
        else:
            raise e
