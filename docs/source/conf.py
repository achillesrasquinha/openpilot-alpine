...
project   = openpilot_alpine.__name__
author    = openpilot_alpine.__author__
copyright = "%s %s" % (NOW.year, openpilot_alpine.__author__)

version   = openpilot_alpine.__version__
release   = openpilot_alpine.__version__
